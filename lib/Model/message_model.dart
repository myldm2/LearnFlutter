...
//   MessageModel(this.ok, this.data);

//   MessageModel.fromJson(Map<String, dynamic> json)
//         : ok = json['ok'],
//           data = new MessageDataModel.fromJson(json['data']);
...
// class MessageDataModel extends Object {
//   // final MessageCardsModel cards;
//   final String cards;

//   MessageDataModel(this.cards);


//   MessageDataModel.fromJson(Map<String, dynamic> json)
//       : cards = json['cards'].toString();
...
// class MessageCardsModel extends Object {
//   final num cardType;
//   final num showType;
//   final List<MessageCardInfoModel> card_group;

//   MessageCardsModel(this.cardType, this.showType, this.card_group);

// }

// class MessageCardInfoModel extends Object {
//   final num card_type;
//   final String card_type_name;
//   final String itemid;
//   final MessageCardActionLogModel actionlog;
//   final num display_arrow;
//   final num show_type;
//   final String scheme;

//   MessageCardInfoModel(this.card_type, this.card_type_name, this.itemid, this.actionlog, this.display_arrow, this.show_type, this.scheme);

//   MessageCardInfoModel.fromJson(Map<String, dynamic> json)
//       : card_type = json['card_type'],
//         card_type_name = json['card_type_name'],
//         itemid = json['itemid'],
//         actionlog = json['actionlog'],
//         display_arrow = json['display_arrow'],
...
// class MessageCardActionLogModel extends Object {
//   final num actCode;
//   final String ext;
//   final String luicode;
//   final String uicode;
//   final String fid;

//   MessageCardActionLogModel(this.actCode, this.ext, this.luicode, this.uicode, this.fid);

//   MessageCardActionLogModel.fromJson(Map<String, dynamic> json)
//         : actCode = json['act_code'],
//           ext = json['ext'],
//           luicode = json['luicode'],
//           uicode = json['uicode'],
//           fid = json['fid'];
...
// abstract class MessageMblogModel extends Object {
...
//   final String mid;
//   final bool can_edit;
//   final num show_additional_indication;
//   final String text;
//   final String source;
//   final bool favorited;
//   final bool is_paid;
//   final num mblog_vip_type;
//   final num pid;
//   final num reposts_count;
//   final num comments_count;
//   final num attitudes_count;
//   final num pending_approval_count;
//   final bool isLongText;
//   final num reward_exhibition_type;
//   final num hide_flag;
//   final num mblogtype;
//   final String rid;
//   final num more_info_type;
//   final num content_auth;
//   final num status;
//   final String digit_attr;
//   final String itemid;
//   final num weibo_position;
//   final num show_attitude_bar;
//   final String raw_text;
//   final String bid;

//   MessageMblogModel(this.created_at, this.id, this.idstr, this.mid, this.can_edit, this.show_additional_indication, this.text, this.source, this.favorited, this.is_paid, this.mblog_vip_type, this.pid, this.reposts_count, this.comments_count, this.attitudes_count, this.pending_approval_count, this.isLongText, this.reward_exhibition_type, this.hide_flag, this.mblogtype, this.rid, this.more_info_type, this.content_auth, this.status, this.digit_attr, this.itemid, this.weibo_position, this.show_attitude_bar, this.raw_text, this.bid);


//   MessageMblogModel.fromJson(Map<String, dynamic> json)
//         : created_at = json['created_at'],
//           id = json['id'],
//           idstr = json['idstr'],
//           mid = json['mid'],
//           can_edit = json['can_edit'],
//           show_additional_indication = json['show_additional_indication'],
//           text = json['text'],
//           source = json['source'],
//           favorited = json['favorited'],
//           is_paid = json['is_paid'],
//           mblog_vip_type = json['mblog_vip_type'],
//           pid = json['pid'],
//           reposts_count = json['reposts_count'],
//           comments_count = json['comments_count'],
//           attitudes_count = json['attitudes_count'],
//           pending_approval_count = json['pending_approval_count'],
//           isLongText = json['isLongText'],
//           reward_exhibition_type = json['reward_exhibition_type'],
//           hide_flag = json['hide_flag'],
//           mblogtype = json['mblogtype'],
//           rid = json['rid'],
//           more_info_type = json['more_info_type'],
//           content_auth = json['content_auth'],
//           status = json['status'],
//           digit_attr = json['digit_attr'],
//           itemid = json['itemid'],
//           weibo_position = json['weibo_position'],
//           show_attitude_bar = json['show_attitude_bar'],
...
//       'reward_exhibition_type': reward_exhibition_type,
//       'more_info_type': more_info_type,
//       'content_auth': content_auth,
//       'status': status,
//       'digit_attr': digit_attr,
//       'weibo_position': weibo_position,
//       'show_attitude_bar': show_attitude_bar,
//       'raw_text': raw_text,
//       'bid': bid,
//     };
...
class MessageModel {
  ...
  MessageModel.fromJson(jsonRes) {
    ok = jsonRes['ok'];
    data = jsonRes['data'] == null ? null : new MessageDataModel.fromJson(jsonRes['data']);
  }
...
class MessageDataModel {
  ...
  MessageDataModel.fromParams({this.showAppTips, this.scheme, this.cards, this.cardlistInfo});
  ...
  MessageDataModel.fromJson(jsonRes) {
    ...
    for (var cardsItem in cards == null ? [] : jsonRes['cards']){
            cards.add(cardsItem == null ? null : new MessageCardsModel.fromJson(cardsItem));
    }

    cardlistInfo = jsonRes['cardlistInfo'] == null ? null : new MessageCardListModel.fromJson(jsonRes['cardlistInfo']);
  }
...
class MessageCardListModel {
  ...
  MessageCardListModel.fromParams({this.can_shared, this.page, this.show_style, this.starttime, this.total, this.containerid, this.page_size, this.title_top, this.v_p, this.cardlist_head_cards, this.cardlist_menus, this.hide_oids, this.toolbar_menus});
  ...
  MessageCardListModel.fromJson(jsonRes) {
    ...
    for (var cardlist_head_cardsItem in cardlist_head_cards == null ? [] : jsonRes['cardlist_head_cards']){
            cardlist_head_cards.add(cardlist_head_cardsItem == null ? null : new MessageHeadCardModel.fromJson(cardlist_head_cardsItem));
    }

    cardlist_menus = jsonRes['cardlist_menus'] == null ? null : [];

    for (var cardlist_menusItem in cardlist_menus == null ? [] : jsonRes['cardlist_menus']){
    ...
    for (var toolbar_menusItem in toolbar_menus == null ? [] : jsonRes['toolbar_menus']){
...
class MessageHeadCardModel {
  ...
  MessageHeadCardModel.fromParams({this.head_type, this.head_type_name, this.menu_scheme, this.show_menu, this.channel_list});
  ...
  MessageHeadCardModel.fromJson(jsonRes) {
    ...
    for (var channel_listItem in channel_list == null ? [] : jsonRes['channel_list']){
            channel_list.add(channel_listItem == null ? null : new MessageChannelModel.fromJson(channel_listItem));
    }
  }
...
class MessageChannelModel {
  ...
  MessageChannelModel.fromParams({this.default_add, this.must_show, this.containerid, this.id, this.name, this.scheme});
...
class MessageCardsModel {
  ...
  MessageCardsModel.fromParams({this.card_type, this.show_type, this.card_group});
  ...
  MessageCardsModel.fromJson(jsonRes) {
    ...
    for (var card_groupItem in card_group == null ? [] : jsonRes['card_group']){
            card_group.add(card_groupItem == null ? null : new MessageCardModel.fromJson(card_groupItem));
    }
  }
...
class MessageCardModel {
  ...
  MessageCardModel.fromParams({this.card_type, this.display_arrow, this.show_type, this.card_type_name, this.itemid, this.scheme, this.actionlog, this.mblog});
  ...
  MessageCardModel.fromJson(jsonRes) {
    ...
    scheme = jsonRes['scheme'];
    actionlog = jsonRes['actionlog'] == null ? null : new MessageActionModel.fromJson(jsonRes['actionlog']);
    // mblog = jsonRes['mblog'] == null ? null : new MessageMblogModel.fromJson(jsonRes['mblog']);
  }
...
class MessageMblogModel {
  ...
  MessageMblogModel.fromParams({this.attitudes_count, this.comments_count, this.content_auth, this.hide_flag, this.mblog_vip_type, this.mblogtype, this.more_info_type, this.pending_approval_count, this.pid, this.reposts_count, this.reward_exhibition_type, this.show_additional_indication, this.show_attitude_bar, this.status, this.weibo_position, this.can_edit, this.favorited, this.isLongText, this.is_paid, this.bid, this.created_at, this.digit_attr, this.id, this.idstr, this.itemid, this.mid, this.raw_text, this.rid, this.source, this.text, this.retweeted_status, this.user, this.visible});
  ...
  MessageMblogModel.fromJson(jsonRes) {
    ...
    text = jsonRes['text'];
    retweeted_status = jsonRes['retweeted_status'] == null ? null : new MessageReweetedStatusModel.fromJson(jsonRes['retweeted_status']);
    user = jsonRes['user'] == null ? null : new MessageUserModel.fromJson(jsonRes['user']);
    visible = jsonRes['visible'] == null ? null : new MessageVisibleModel.fromJson(jsonRes['visible']);
  }
...
class MessageUserModel {
  ...
  MessageUserModel.fromParams({this.follow_count, this.followers_count, this.id, this.mbrank, this.mbtype, this.statuses_count, this.urank, this.verified_type, this.verified_type_ext, this.close_blue_v, this.follow_me, this.following, this.like, this.like_me, this.verified, this.avatar_hd, this.cover_image_phone, this.description, this.gender, this.profile_image_url, this.profile_url, this.screen_name, this.verified_reason, this.badge});
  ...
  MessageUserModel.fromJson(jsonRes) {
    ...
    badge = jsonRes['badge'] == null ? null : new MessageBadageModel.fromJson(jsonRes['badge']);
  }
...
class MessageBadageModel {
  ...
  MessageBadageModel.fromParams({this.double11_2018, this.national_day_2018, this.qixi_2018, this.suishoupai_2018, this.unread_pool, this.unread_pool_ext, this.user_name_certificate, this.wenda_v2, this.zongyiji});
...
class MessageReweetedStatusModel {
  ...
  MessageReweetedStatusModel.fromParams({this.attitudes_count, this.comments_count, this.content_auth, this.edit_count, this.hide_flag, this.mblog_vip_type, this.mblogtype, this.more_info_type, this.pending_approval_count, this.reposts_count, this.retweeted, this.reward_exhibition_type, this.show_additional_indication, this.show_attitude_bar, this.status, this.textLength, this.weibo_position, this.can_edit, this.favorited, this.isLongText, this.is_paid, this.bid, this.bmiddle_pic, this.cardid, this.created_at, this.edit_at, this.id, this.idstr, this.mid, this.original_pic, this.picStatus, this.source, this.text, this.thumbnail_pic, this.pics, this.user, this.visible});
  ...
  MessageReweetedStatusModel.fromJson(jsonRes) {
    ...
    for (var picsItem in pics == null ? [] : jsonRes['pics']){
            pics.add(picsItem == null ? null : new MessagePictureModel.fromJson(picsItem));
    }
...
class MessageBadgeModel {
  ...
  MessageBadgeModel.fromParams({this.dzwbqlx_2016, this.qixi_2018, this.suishoupai_2018, this.super_star_2018, this.travel_2017, this.unread_pool, this.unread_pool_ext, this.user_name_certificate, this.worldcup_2018});
...
class MessagePictureModel {
  ...
  MessagePictureModel.fromParams({this.pid, this.size, this.url, this.geo, this.large});
  ...
  MessagePictureModel.fromJson(jsonRes) {
    ...
    large = jsonRes['large'] == null ? null : new MessageLargeModel.fromJson(jsonRes['large']);
  }
...
class MessageActionModel {
  ...
  MessageActionModel.fromParams({this.act_code, this.ext, this.fid, this.luicode, this.uicode});
